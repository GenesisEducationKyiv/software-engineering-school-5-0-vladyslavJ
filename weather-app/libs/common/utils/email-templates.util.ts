...
export const confirmTpl = (appBaseUrl: string, confirmationToken: string) => ({
  ...
  html: `
		<div style="font-family:sans-serif; background:#f1f5f9; padding:24px">
			<div style="max-width:420px;margin:auto;background:white;border-radius:12px;padding:32px 20px;text-align:center;box-shadow:0 2px 16px #0001;">
				...
				<a href="${appBaseUrl}/api/confirm/${confirmationToken}" style="display:inline-block;padding:10px 22px;background:#2563eb;color:white;text-decoration:none;border-radius:8px;font-size:1.1rem;">Confirm</a>
		...
		<div style="font-family:sans-serif; background:#f1f5f9; padding:24px">
			<div style="max-width:420px;margin:auto;background:white;border-radius:12px;padding:32px 20px;text-align:center;box-shadow:0 2px 16px #0001;">
				...
				<small style="color:#64748b;">
					...
					<a href="${appBaseUrl}/api/unsubscribe/${unsubscribeToken}" style="color:#ef4444;text-decoration:none;">
						click here
					</a>
				</small>
			</div>
		...
		<div style="font-family:sans-serif; background:#f1f5f9; padding:24px">
			<div style="max-width:420px;margin:auto;background:white;border-radius:12px;padding:32px 20px;box-shadow:0 2px 16px #0001;">
				...
				<ul style="list-style:none;padding:0;margin:0 0 24px 0;">
					<li style="margin-bottom:8px;"><b>Temperature:</b> <span style="color:#0ea5e9">${weather.temperature} °C</span></li>
					<li style="margin-bottom:8px;"><b>Humidity:</b> <span style="color:#38bdf8">${weather.humidity}%</span></li>
					<li><b>Description:</b> <span style="color:#334155">${weather.description}</span></li>
				</ul>
				...
				<small style="color:#64748b;">Unsubscribe: 
					<a href="${appBaseUrl}/api/unsubscribe/${unsubscribeToken}" style="color:#ef4444;text-decoration:none;">click here</a>
				</small>
			</div>
		</div>
	`,
